...
from simulator.core.memmap import BaseMemoryMap, AddressSpace
...
def create_address_space_from_config(mem_config: MemoryConfig) -> AddressSpace:
    ...
    sram = RamMemory(AddressRange(mem_config.sram_base, mem_config.sram_size), name="SRAM")
    mmio = PeripheralWindow(AddressRange(mem_config.periph_base, mem_config.periph_size))
    ...
    bitband_regions = [
        ...
        BitBandRegion(
            AddressRange(mem_config.bitband_periph_base, mem_config.bitband_periph_size),
