/* main.c - example firmware for the simulator */

// arm-none-eabi-gcc -mcpu=cortex-m3 -mthumb -Os -ffreestanding -nostdlib "-Wl,-T,linker.ld" startup.c main.c -o firmware.elf
